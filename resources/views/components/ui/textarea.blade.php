@props(['label' => null, 'name', 'hint' => null, 'required' => false, 'rows' => 4])
...
<div {{ $attributes->only('class') }}>
    ...
    <textarea
        ...
        {{ $attributes->except('class')->class([
            'block w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-slate-800 shadow-sm transition placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20',
