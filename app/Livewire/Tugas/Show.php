...
class Show extends Component
{
    ...
    {
        return PesanWhatsApp::tugas($this->tugas->loadMissing(['mataKuliah:id,kelas_id,kode,nama,dosen,sks', 'kategoriKelompok:id,nama']), $this->kelas);
    }
    ...
    {
        $this->tugas->loadMissing(['mataKuliah:id,kelas_id,kode,nama,dosen,sks', 'creator:id,name', 'kategoriKelompok:id,nama']);
