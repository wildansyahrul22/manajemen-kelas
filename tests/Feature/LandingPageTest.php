...
class LandingPageTest extends TestCase
{
    public function test_guests_see_the_subscription_offer_with_both_plans_and_the_contacts(): void
    {
        $this->get(route('landing'))
            ...
            ->assertSee('Rp150.000')
            ->assertSee('Rp200.000')
            ->assertSee('<s class="angka text-xl font-semibold text-[var(--redup)]">Rp200.000</s>', escape: false)
            ->assertSee('<s class="angka text-xl font-semibold text-white/50">Rp250.000</s>', escape: false)
